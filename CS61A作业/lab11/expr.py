...
class CallExpr(Expr):
    ...
    def eval(self, env):
        ...
        for operand in operands:
            operands_new.append(operand.eval(env=env))
        return operator.eval(env).apply(operands_new)
        #print(operator.eval(env = env))
        #for operand in operands:
        #    print(operand.eval(env = env))
        #return None
...
class LambdaFunction(Value):
    ...
    def apply(self, arguments):
        ...
        for i in range(len(self.parameters)):
            ...
            #print(arguments[i].eval(self.parent))
        return self.body.eval(env = env)
