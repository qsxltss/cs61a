...
class Player:
    ...
    def play(self, card_index):
        ...
        for i in range(0,len(self.hand)):
          if i != card_index: new_hand+=[self.hand[i]]
          else: card_choose = self.hand[i]
        self.hand=new_hand
        return card_choose
...
class TutorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        new_hand = opponent.hand[3:]
        opponent.hand=new_hand
        #opponent.hand.pop()
        for i in range(3):
          opponent.draw()
...
class TACard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        """
        "*** YOUR CODE HERE ***"
        num = other_card.attack
        other_card.attack = other_card.defense
        other_card.defense =num
...
class ProfessorCard(Card):
    ...
    def effect(self, other_card, player, opponent):
        ...
        for x in opponent.deck.cards:
          if x.attack!=other_card.attack and x.defense != other_card.defense:
            new_cards+=[x]
